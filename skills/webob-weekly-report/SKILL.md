...
`/Users/zhoumeng/Documents/Codex/2026-04-24/new-chat`
...
```bash
python3 /Users/zhoumeng/.codex/skills/webob-weekly-report/scripts/run_webob_report.py
```

2. To sync generated TSVs to Feishu Bitable API, run this after action-time confirmation:

```bash
python3 /Users/zhoumeng/.codex/skills/webob-weekly-report/scripts/run_webob_report.py --sync-feishu
```
...
```bash
python3 /Users/zhoumeng/.codex/skills/webob-weekly-report/scripts/run_webob_report.py --today 2026-04-27 --sync-feishu
```
...
```bash
python3 /Users/zhoumeng/.codex/skills/webob-weekly-report/scripts/run_webob_report.py --sync-feishu --cleanup-empty
```

3. To also send a short summary and Bitable link to 企业微信, only run this after action-time confirmation:

```bash
python3 /Users/zhoumeng/.codex/skills/webob-weekly-report/scripts/run_webob_report.py --sync-feishu --send-qiwei
```
